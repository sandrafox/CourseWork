...
public class Visualizer extends ApplicationFrame {
    ...
    public Visualizer(String title, String chartTitle) throws GAException, IOException {
        super(title);

        myWriter = new FileWriter("VectorWith0.1HeNew-i0sf.out");
    ...
    public XYDataset createDataset( ) throws GAException, IOException {
        ...
        myWriter.write("[{}\n");
        final int nRuns = 100;
        for (int n1 = 512; n1 <= 768; n1 += 8) {//512 - 1024 (512 - 768)
            final int n = n1;
            //final int n = 1 << N;
...
//                    1 / (double)(2 * N));
    ...
    public void savePlot() throws IOException {
        ...
        File XYChart = new File( "VectorWith0.1HeNew-i0.jpeg" );
