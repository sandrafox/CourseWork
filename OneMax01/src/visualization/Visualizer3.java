...
public class Visualizer3 extends ApplicationFrame {
    ...
    public Visualizer3(String title, String chartTitle) throws GAException, IOException {
        super(title);

        myWriter = new FileWriter("VectorWith0.1HeNew-i2sf.out");
    ...
    public XYDataset createDataset( ) throws GAException, IOException {
        ...
        myWriter.write("[{}\n");
        final int nRuns = 100;
        for (int n1 = 864; n1 <= 912; n1 += 8) { //864 - 912
            final int n = n1;
            //final int n = 1 << N;
...
//                    1 / (double)(2 * N));
    ...
    public void savePlot() throws IOException {
        ...
        File XYChart = new File( "VectorWith0.1HeNew-i2.jpeg" );
