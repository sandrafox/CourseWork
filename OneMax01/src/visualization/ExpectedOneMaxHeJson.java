...
public class ExpectedOneMaxHeJson {
    private static FileWriter myWriter;

    public ExpectedOneMaxHeJson(String title) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ExpectedOneMaxHeJson chart = new ExpectedOneMaxHeJson("Expected time for OneMaxHe Quadratic");
        chart.createDataset();
    }
}
