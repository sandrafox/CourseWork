...
public class V4 extends ApplicationFrame {
    ...
    public V4(String title, String chartTitle) throws GAException, IOException {
        super(title);

        myWriter = new FileWriter("VectorWith0.1HeNew-i3sf.out");
    ...
    public XYDataset createDataset( ) throws GAException, IOException {
        ...
        myWriter.write("[{}\n");
        final int nRuns = 100;
        for (int n1 = 920; n1 <= 1024; n1 += 8) {//920 - 1024
            final int n = n1;
            //final int n = 1 << N;
...
//                    1 / (double)(2 * N));
    ...
    public void savePlot() throws IOException {
        ...
        File XYChart = new File( "VectorWith0.1HeNew-i3.jpeg" );
